<!--TITLE: Select Item In Element Command -->
...
- [Please Select the Item Value to Select](#param_1)
...
<a id="param_1"></a>
### Please Select the Item Value to Select
...
<dt>Sample Usage</dt><dd><strong>vResult</strong> or <strong>{vResult}</strong> or <strong>Yes</strong> or <strong>Hello</strong> or <strong>{vItem}</strong></dd>
<dt>Remarks</dt><dd>(nothing)</dd>
</dl>
