...
<a id="param_list"></a>
## Command Parameters
- [Please Specify the path of the folder you want to check for existence](#param_0)
- [Please Specify the variable to assign the result](#param_1)
- [Optional - Please Specify the Comment Field](#param_2)


<a id="param_0"></a>
### Please Specify the path of the folder you want to check for existence
