<!--TITLE: Get DataTable Column List Command -->
<!-- SUBTITLE: a command in the DataTable Commands group. -->
[Go To Automation Commands Overview](/automation-commands.md)


DataTable Commands &gt; Column Action &gt; Get DataTable Column List


# Get DataTable Column List Command


## What does this command do?
This command allows you to get the column name List of a DataTable


## When would I want to use this command?
Use this command when you want to get the column name List of a DataTable.
